...
function activeLink() {
    ...
    _jqueryDefault.default('.recipe').siblings().removeClass('active');
    _jqueryDefault.default(`#${id}`).addClass('active');
...
function handlerCollapseList() {
    collapseIconSelector.addEventListener('click', ()=>{
        if (recipeListSelector.style.width == '0px') {
            recipeListSelector.style.width = '300px';
            detailsContainerSelector.style.marginLeft = "300px";
        } else {
            recipeListSelector.style.width = '0';
            detailsContainerSelector.style.marginLeft = "0";
        }
...
},{"../comman":"1AQuR","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","jquery":"bE6My"}],"bE6My":[function(require,module,exports) {
/*!
...
},{}]},["JgjJu","jrv7n"], "jrv7n", "parcelRequiree88c")
